...
#Training data
python3 train.py -data data/src-train -save_model test-model
...
python3 preprocess.py -train_src data/src-en-afr.txt -train_tgt data/tgt-en-afr.txt -save_data data/prep
